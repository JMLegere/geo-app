...
**Status:** Active delivery plan, prepared 2026-09-06 from the approved issue
contract and draft implementation checkpoint and activated by the subsequent
human instruction to execute it. This document does not itself accept artwork,
prove behavior, or authorize a production deployment.
