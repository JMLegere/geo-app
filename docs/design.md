...
- Rewards are immediate plus ledger/history only; there is no durable Rehab Trust/reputation track. Default one-off release reward is Orbs only: simple, readable, and useful across the game.
