...
- Rewards are immediate plus ledger/history only; there is no durable Rehab Trust/reputation track. Default one-off release reward is a flat Orb amount for any eligible fauna; local programs add fixed Orb bonuses.
