...
- Rewards are immediate plus ledger/history only; there is no durable Rehab Trust/reputation track. Small Orb payout remains the current default reward direction unless replaced.
