...
| `docs/prd-shadcn-ui-reset.md` | `CURRENT-SCOPED` | Phase 4 complete; Phase 5+ paused pending explicit authorization for Issue #580's pure `shadcn_ui` reset; production deployment is not authorized |
