...
void main() {
  const migratedSurfaces = <String, List<String>>{
    'lib/ui/product_surfaces/auth/screens/login_screen.dart': [
      'AppCard',
      'AppButton',
      'ShadInput',
    ],
    'lib/ui/product_surfaces/auth/screens/loading_screen.dart': [
      'AppCard',
      'LoadingDots',
    ],
    'lib/ui/product_surfaces/app/app_readiness_gate.dart': [
      'AppCard',
      'AppButton',
      'AppNotice',
      'ShadProgress',
    ...
    'lib/ui/product_surfaces/profile/screens/settings_screen.dart': [
      'AppCard',
      'AppFieldRow',
      'AppButton',
      'ShadSwitch',
  ...
  group('Phase 2 shell source contract', () {
    ...
    test('keeps Map and Pack as the only destinations and Settings separate', () {
      ...
      expect(
        File(
          'lib/ui/design_system/primitives/app_nav_button.dart',
        ).readAsStringSync(),
