...
void main() {
  group('Phase 4 semantic renderer contracts', () {
    test('assigns only calibrated semantic ownership to Map render surfaces', () {
      ...
      expect(
        surfaces['lib/ui/product_surfaces/map/rendering/cell_overlay_painter.dart']!
            .designSystemNotes,
        contains('Phase 4 Fog composition'),
      );
      expect(
        surfaces['lib/ui/product_surfaces/map/rendering/player_marker.dart']!
            .designSystemNotes,
        contains('one marker system'),
      );
      expect(
        surfaces['lib/ui/product_surfaces/map/widgets/hierarchy_exploration_map.dart']!
            .designSystemNotes,
        contains('child summary counts and fixed-tile presentation behavior'),
      );
      expect(
        surfaces['lib/ui/product_surfaces/map/widgets/district_footprint_map.dart']!
            .designSystemNotes,
    ...
    test('keeps renderer sources free of retired theme and hue semantics', () {
      const rendererPaths = [
        ...
        'lib/ui/product_surfaces/map/widgets/hierarchy_exploration_map.dart',
        'lib/ui/product_surfaces/map/widgets/district_footprint_map.dart',
      ];
