...
void main() {
  ...
  group('AppReadinessGate', () {
    ...
    testWidgets('failure offers Retry and Sign out instead of progress', (
      ...
      expect(find.text('Copy diagnostic summary'), findsOneWidget);
    ...
    testWidgets(
      'failure copies a diagnostic summary and readiness state',
      (tester) async {
        ...
        await tester.tap(find.text('Copy diagnostic summary'));
        await tester.pump();
        ...
        expect(find.text('Diagnostic summary copied'), findsOneWidget);
      },
    );
