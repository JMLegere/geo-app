...
export const actionCapabilities = {
  ...
  examinePackItem: mutationAction(
    "examine-pack-item",
    "Examine a Pack Item",
    "Unexamined Pack Item",
    "recognizes the same owned Item's Base Item through durable Journal knowledge without a Villager, Venue, Service, or Property Value mutation",
    playerActionWorkflows.discoveryOwnership,
  ),
  openIdentificationService: navigationAction(
    "open-identification-service",
    "Open Identification Service",
    "Examined Pack Item detail",
    "opens the distinct known-Villager Identification Service for the same examined unidentified Item without activating Town as a bottom destination or committing Identification",
    playerActionWorkflows.discoveryOwnership,
  ),
  identifyUnidentifiedFind: mutationAction(
    "identify-unidentified-find",
    "Start Item Identification",
    "Identification Service",
    "starts the prepared Identification Service flow for an examined, unidentified, owned active Item using the retained current Villager and Service Version; it does not commit Property Values",
    playerActionWorkflows.discoveryOwnership,
  ),
  revealIdentification: mutationAction(
    "reveal-identification",
    "Reveal an Item identification",
    "Identification Service reveal",
    "commits the retained prepared plan for the same exact Item only after hold/reveal; cancellation before reveal writes no Property Values",
    playerActionWorkflows.discoveryOwnership,
  ),
