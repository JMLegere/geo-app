...
export const actionCapabilities = {
  ...
  openPack: navigationAction(
    ...
    "Open the Pack",
    "Pack tab",
    "opens owned finds and mystery cards without changing find state",
    playerActionWorkflows.discoveryOwnership,
  ),
  inspectPackFind: viewAction(
    ...
    "Inspect a Pack find",
    "Pack find detail",
    "shows owned-find details, acquisition history, and available handoffs without mutating ownership",
    playerActionWorkflows.discoveryOwnership,
  ),
  identifyMystery: mutationAction(
    "identify-mystery",
    "Identify a mystery",
    "Identification surface",
    "starts an eligible unknown-to-known identification reveal for a mystery find",
    playerActionWorkflows.discoveryOwnership,
  ),
  revealIdentification: mutationAction(
    ...
    "commits deterministic identification result, traits, and known-state transition for a mystery find",
    playerActionWorkflows.discoveryOwnership,
  ),
