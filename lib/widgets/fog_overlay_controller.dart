...
import 'package:earth_nova/domain/fog/fog_resolver.dart' show FogStateResolver;
import 'package:earth_nova/models/cell_properties.dart';
import 'package:earth_nova/models/fog_state.dart';
import 'package:earth_nova/widgets/cell_property_geojson_builder.dart';
import 'package:earth_nova/widgets/fog_geojson_builder.dart';
import 'package:earth_nova/widgets/habitat_fill_geojson_builder.dart';
import 'package:earth_nova/widgets/mercator_projection.dart';
import 'package:earth_nova/widgets/territory_border_geojson_builder.dart';
...
class FogOverlayController {
  ...
  void update({
    ...
    if (sw.elapsedMilliseconds > 8 || _fogComputeCounter % 50 == 1) {
      ...
      // ObservabilityBuffer removed in v2.
    }
  }
